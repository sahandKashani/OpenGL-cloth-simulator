...
StructuralBendConstraint::StructuralBendConstraint(Node* n1, Node* n2) :
    Constraint(n1, n2)
{}

void StructuralBendConstraint::draw()
{
    glPushAttrib(GL_POLYGON_BIT); // save mesh settings
        ...
        glPushAttrib(GL_CURRENT_BIT); // save color
            ...
            {
                Vector3 color = DrawingSettings::getInstance()->getStructuralBendConstraintColor();
