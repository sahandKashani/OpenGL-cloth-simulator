...
private:
	...
	*/
	...
	void drawTriangle(Particle *p1, Particle *p2, Particle *p3, const Vec3 color)
	{
		...
		Vec3 first_point = p1->getNormal().normalized();
		Vec3 second_point = p2->getNormal().normalized();
		Vec3 third_point = p3->getNormal().normalized();

		glNormal3fv((GLfloat *) &(first_point ));
		glVertex3fv((GLfloat *) &(p1->getPos() ));

		glNormal3fv((GLfloat *) &(second_point ));
		glVertex3fv((GLfloat *) &(p2->getPos() ));

		glNormal3fv((GLfloat *) &(third_point ));
